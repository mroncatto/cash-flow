...
class AllTransactionModel {
  ...
  AllTransactionModel.fromJson(dynamic json) {
...
class Data {
  Data({
    List<TransactionData>? cryptoCurrencyList,
    String? totalCount,}){
  ...
  Data.fromJson(dynamic json) {
    if (json['cryptoCurrencyList'] != null) {
      ...
      json['cryptoCurrencyList'].forEach((v) {
        _cryptoCurrencyList?.add(TransactionData.fromJson(v));
      });
    }
    _totalCount = json['totalCount'];
  }
  List<TransactionData>? _cryptoCurrencyList;
  String? _totalCount;

  List<TransactionData>? get cryptoCurrencyList => _cryptoCurrencyList;
  String? get totalCount => _totalCount;


  set cryptoCurrencyList(List<TransactionData>? value) {
